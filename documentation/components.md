...
const Footer = () => (
  <footer>
    ...
    <div className="copyright">
      ...
      <small>CardConnectSF is an independent sales division of CardConnect,inc. </small>
    </div>
  </footer>
);
